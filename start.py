...
if option == 1:
    ...
    if isfile("users.html") == True:
        ...
        with open("users.html", "w") as fileObject:
            ...
            fileObject.write("<table border='1', cellspacing='2', cellpadding='0'><thead><th>Username</th><th>Email Address</th></thead><tbody><tr><td>" +username+ "</td><td>"+ email + "</td></tr></tbody></table>")
